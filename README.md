...
## Instructions
Follow the instructions in Tennis.ipynb to get started with training your own agent! you will see how to train a pair of agents to play tennis.<br>
After finishing your agent training, you can check a score by plotting average scores over episodes.
It will tell you how many epsiodes in your model are needed to get +0.5 average score. you can also save model weights and load it later.
